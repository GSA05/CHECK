...
void BeginToken(char *t) {
  ...
  /*================================================================*/
  /* location for bison --------------------------------------------*/
  macsinlloc.first_line = nRow;
  macsinlloc.first_column = nTokenStart;
  macsinlloc.last_line = nRow;
  macsinlloc.last_column = nTokenStart + nTokenLength - 1;

  if (  debug  ) {
    printf("Token '%s' at %d:%d next at %d\n", dumpString(t),
                        macsinlloc.first_column,
                        macsinlloc.last_column, nTokenNextStart);
  }
}
